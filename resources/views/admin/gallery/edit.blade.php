            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <input name="title" type="text" class="form-control form-control-line" value="{{$gallery->title}}" required >
                        <br>
                        <br>
                        <label for="input-file-now">Category</label>
                        <input name="category" type="text" class="form-control form-control-line" value="{{$gallery->category}}" required >
                        <br>
                        <br>
