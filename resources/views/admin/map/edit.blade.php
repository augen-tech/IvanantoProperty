...
@section('content')
    <form action="{{route('admin.map.update', $map->id)}}" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">File Upload Gambar Map</h4>      
                        <label for="input-file-now">Gambar Map</label>
                        <input required name="path" type="file" id="input-file-now" class="dropify" required/>
                        <label for="input-file-now">Title</label>
                        <input required name="title" type="text" class="form-control form-control-line" value="{{$map->title}}">
                        <br>
                        <br>
                        <label for="input-file-now">Description</label>
                        <input required name="description" type="text" class="form-control form-control-line" value="{{$map->description}}">
                        <br>
                        <br>
